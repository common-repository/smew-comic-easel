...
Author: Philip M. Hofer (Frumph), with modifications by Chrisitna "Smudge" Hanson (smudge)
...
class ce2s_thumbnail_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($instance['inhistory'])
			...
			$memberlevel_drip .= " ago";
			$ce_s2_date_query = array('column' => 'post_date_gmt','before' => $memberlevel_drip,);
			}

		if ($instance['thumbchapt'] !== 'All') $chaptinfo = $instance['thumbchapt'];
